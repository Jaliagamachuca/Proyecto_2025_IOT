...
public class EditarPerfilActivityGuia extends AppCompatActivity {

    ActivityEditarPerfilGuiaBinding binding;
    String uid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityEditarPerfilGuiaBinding.inflate(getLayoutInflater());
