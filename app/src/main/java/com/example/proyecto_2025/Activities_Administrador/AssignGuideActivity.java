...
public class AssignGuideActivity extends AppCompatActivity {
    ...
    private void escucharTour() {
        db.collection("tours").document(tourId)
                .addSnapshotListener((doc, e) -> {
                    ...
                    String estado = (tour.estado != null) ? tour.estado.name() : (doc.getString("estado") != null ? doc.getString("estado") : "-");
    ...
    private void aceptarGuia() {
        ...
        // Aceptar: deja guiaId tal cual y vuelve a PENDIENTE_GUIA (listo para publicar a clientes)
        ...
        db.collection("tours").document(tourId)
                ...
                .addOnSuccessListener(x -> {
                    Toast.makeText(this, "Guía aceptado. Tour listo para publicar.", Toast.LENGTH_LONG).show();
                    finish();
                })
